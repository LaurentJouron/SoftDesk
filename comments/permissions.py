...
class IsIssueAuthor(permissions.BasePermission):
    """
    Custom permission to check if the user is the author of the associated issue.

    This permission class is used to determine whether a user has permission
    to access and modify a specific comment. Users can access and modify comments
