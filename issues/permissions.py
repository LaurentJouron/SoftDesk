...
class IsProjectAuthorOrContributor(permissions.BasePermission):
    """
    Custom permission to check if the user is the project author or a contributor.
    ...
    if they are either the author of the project or a contributor to the project.
    ...
    def has_object_permission(self, request, view, obj):
        ...
        Returns:
            bool: True if the user is the author of the project or a contributor,
            False otherwise.
        """
